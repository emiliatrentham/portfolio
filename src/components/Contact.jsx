          ...
          <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full py-60'>
              ...
              <div className='mt-20 flex justify-center items-center '>
                  <form action='' className='flex flex-col w-full md:w-1/2'>
                      <input value={name}  onChange={handleInputChange} type='text' name='name' placeholder='Enter your name' className='text-white p-2 bg-transparent border-2 rounded-md focus:outline-none'></input>
                      <input value={email}  onChange={handleInputChange} type='text' name='email' placeholder='Enter your email' className='text-white my-4 p-2 bg-transparent border-2 rounded-md focus:outline-none' ></input>
