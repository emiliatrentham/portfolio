...
const Home = () => {
    return (
        <div name='home' className='h-screen w-full bg-gradient-to-b from-lime-600 via-emerald-300 to-white-800'>
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
                <div className='flex flex-col justify-center h-full'>
                    ...
                    <p className='text-gray-500 py-4 max-w-lg'>
                        ...
                        netus nulla tempor litora ante purus phasellus eros, diam cras congue ullamcorper hac pulvinar vitae.
                    </p>
                    <div >
